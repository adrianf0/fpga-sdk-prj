...
# Create project
create_project zynq_scr1 ./zynq_scr1 -part xczu6eg-ffvc900-1-i
...
set obj [get_projects zynq_scr1]
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/zynq_scr1.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/zynq_scr1.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/zynq_scr1.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/zynq_scr1.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/zynq_scr1.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/zynq_scr1.cache/compile_simlib/vcs" $obj
...
set_property "ip_output_repo" "$proj_dir/zynq_scr1.cache/ip" $obj
...
set files [list \
 ...
 "[file normalize "$origin_dir/src/zynq_scr1.sv"]"\
]
...
set file "$origin_dir/src/zynq_scr1.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "SystemVerilog" $file_obj
set_property "is_enabled" "1" $file_obj
...
set_property "top" "zynq_scr1_top" $obj
...
set file "[file normalize "$origin_dir/constrs/zynq_scr1_synth.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/constrs/zynq_scr1_synth.xdc"
set file [file normalize $file]
...
set_property "target_constrs_file" "[file normalize "$origin_dir/constrs/zynq_scr1_synth.xdc"]" $obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constrs/zynq_scr1_physical.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/constrs/zynq_scr1_physical.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_2] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
set_property "is_enabled" "1" $file_obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/constrs/zynq_scr1_timing.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/constrs/zynq_scr1_timing.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_2] [list "*$file"]]
set_property "file_type" "XDC" $file_obj
set_property "is_enabled" "1" $file_obj
